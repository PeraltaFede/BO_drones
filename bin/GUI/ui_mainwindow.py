...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionMostrar_Puntos_de_Medici_n = QAction(MainWindow)
        self.actionMostrar_Puntos_de_Medici_n.setObjectName(u"actionMostrar_Puntos_de_Medici_n")
        ...
        self.menuVista.addSeparator()
        self.menuVista.addAction(self.actionMostrar_Puntos_de_Medici_n)
...
#endif // QT_CONFIG(shortcut)
        self.actionMostrar_Puntos_de_Medici_n.setText(QCoreApplication.translate("MainWindow", u"Mostrar Puntos de Medici\u00f3n", None))
#if QT_CONFIG(shortcut)
        self.actionMostrar_Puntos_de_Medici_n.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
